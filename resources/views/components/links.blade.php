<section class="enlaces my-2">
    <div class="container-md">
        <div class="row justify-content-between align-items-center ">
            <div class="col-4 col-md-4 col-lg-2 text-center">
                <a href="#" class="">
                    <div class="icon-enlace py-2">
            ...
            <div class="col-4 col-md-4 col-lg-2 text-center">
                <div class="dropdown">
                    <div class="icon-enlace py-2" type="button" id="FormasdePago" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
